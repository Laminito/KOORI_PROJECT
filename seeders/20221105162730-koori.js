...
module.exports = {
    async up(queryInterface, Sequelize) {
        const newLocal = "Toutefois chaque ,koori peut être utilisé indépendamment. Par exemple, face à une recherche de solutions à un concept bien défini, le cauri  orange (idéation) peut être aisément  utilisé pour co-imaginer des solutions innovantes et en rupture avec l’existant.\n";
        return queryInterface.bulkInsert('Kooris', [{
    ...
    async down(queryInterface, Sequelize) {
        ...
        return queryInterface.bulkDelete('Kooris', null, {});
    }
};